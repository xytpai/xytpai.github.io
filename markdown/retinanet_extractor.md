| [返回主页](index.html) | [数据集接口](retinanet_dataset.html) | 特征提取器 | [检测器](retinanet_detector.html) | [锚生成器](retinanet_anchors.html) | [解析器](retinanet_encoder.html) |  [损失接口](retinanet_loss.html) | [训练过程](retinanet_train.html) | [推理过程](retinanet_inference.html) | [性能评估](retinanet_eval.html) |
...
Bottleneck 为 Resnet 的基本计算单元，其先用1X1卷积核聚焦有用通道，再使用3X3做空间卷积，以减少计算量，是一种对于卷积输入通道的注意力机制。
