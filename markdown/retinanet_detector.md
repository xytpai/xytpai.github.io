| [返回主页](index.html) | [数据集接口](retinanet_dataset.html) | [特征提取器](retinanet_extractor.html) | 检测器 | [锚生成器](retinanet_anchors.html) | [解析器](retinanet_encoder.html) |  [损失接口](retinanet_loss.html) | [评估接口](retinanet_eval.html) | [训练流程](retinanet_train.html) | 
...
Retinanet 是基于FPN的检测器，FPN将高层与低层特征进行相加以结合语义信息与结构信息。
